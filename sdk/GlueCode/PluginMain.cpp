...
#if !TARGET_OS_IOS && (TARGET_CARBON || TARGET_COCOA)
...
void REALInsertArrayValuePtr(REALarray arr, RBInteger index, void *value)
{
	static void* (*pInsertArrayValueProc)(REALarray) = nil;
	if (!pInsertArrayValueProc)
		pInsertArrayValueProc = (void* (*)(REALarray)) CallResolver("PluginIntegerArrayInsertProc");
...
#endif
	if (pInsertArrayValueProc) {
		void(*fp)(REALarray, RBInteger, void*) = (void(*)(REALarray, RBInteger, void*))pInsertArrayValueProc(arr);
		if (fp)	fp(arr, index, value);
	}
}
...
void REALGetArrayValuePtr(REALarray arr, RBInteger index, void **value)
{
	static void* (*pGetArrayValueProc)(REALarray) = nil;
	if (!pGetArrayValueProc)
		pGetArrayValueProc = (void* (*)(REALarray)) CallResolver("PluginObjectArrayGetProc");
...
void REALSetArrayValuePtr(REALarray arr, RBInteger index, void *value)
{
	static void* (*pSetArrayValueProc)(REALarray) = nil;
	if (!pSetArrayValueProc)
		pSetArrayValueProc = (void* (*)(REALarray)) CallResolver("PluginObjectArraySetProc");
...
#endif
	if (pSetArrayValueProc) {
		void(*fp)(REALarray, void*, RBInteger) = (void(*)(REALarray, void*, RBInteger))pSetArrayValueProc(arr);
		if (fp)	fp(arr, value, index);
	}
}
...
void REALInsertArrayValue(REALarray arr, RBInteger index, void *value)
{
	REALInsertArrayValuePtr(arr, index, value);
}
...
void REALGetArrayValue(REALarray arr, RBInteger index, void** value)
{
	REALGetArrayValuePtr(arr, index, value);
}
...
void REALSetArrayValue(REALarray arr, RBInteger index, void *value)
{
	REALSetArrayValuePtr(arr, index, value);
}
...
RBBoolean REALUseNativeControlSizes()
{
	static RBBoolean(*pUseNativeControlSizes)(void);
	if (!pUseNativeControlSizes) {
		pUseNativeControlSizes = (RBBoolean(*)(void))CallResolver("UseNativeControlSizes");
	}
	if (pUseNativeControlSizes) return pUseNativeControlSizes();
	return false;
}

RBBoolean REALUsesWinUI()
{
	static RBBoolean(*pUsesWinUI)(void);
	if (!pUsesWinUI) {
		pUsesWinUI = (RBBoolean(*)(void))CallResolver("UsesWinUI");
	}
	if (pUsesWinUI) return pUsesWinUI();
	return false;
}
