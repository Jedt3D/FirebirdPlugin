...
REAL_DEPRECATED_("Use REALInsertArrayValuePtr") void REALInsertArrayValue(REALarray arr, RBInteger index, void *value);
#if !TARGET_64BIT
...
REAL_DEPRECATED_("Use REALGetArrayValuePtr") void REALGetArrayValue(REALarray arr, RBInteger index, void **value);
#if !(UNIX_ANSI && TARGET_64BIT)
...
REAL_DEPRECATED_("Use REALSetArrayValuePtr") void REALSetArrayValue(REALarray arr, RBInteger index, void *value);
#if !(UNIX_ANSI && TARGET_64BIT)
