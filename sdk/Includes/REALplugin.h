...
typedef struct
{
	...
	/// Same as addTableRecord but returns a unique new value that identifies the row.
	RBInteger (*AddRowWithReturnValue)(dbDatabase*, REALstring tableName, REALcolumnValue* values, REALstring idColumnName);
