...
#if TARGET_WIN32
/**
* This function converts a Xojo Picture into a Windows HBITMAP and draws it onto the
* provided device context, with optional white transparency.
*
* @param hDC The Windows device context to draw onto.
* @param pic The Xojo Picture object to draw.
* @param rBounds The rectangle specifying where the image should be drawn.
* @param bTransparent True to mask out the White portions to make them transparent, False otherwise.
*
* @version Undeprecated in 2025r3
*/
void REALDrawPicturePrimitive(HDC hDC, REALpicture pic, const Rect *rBounds, int bTransparent);
#endif

/**
* Currently this function only returns true if building for WinUI with
* the Use Native WinUI Sizes enabled in the Windows Build Settings.
*
* @version Added in 2025r3
*/
RBBoolean REALUseNativeControlSizes();

/**
* Determines if the App is built using the WinUI framework.
*
* @return True if the app uses the WinUI framework, False otherwise.
*
* @version Added in 2025r3.1
*/
